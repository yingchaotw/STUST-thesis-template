...
\ifCoAdvisor
\makebox[5.8em][s]{\textbf{\fontsize{18}{0}\selectfont 共\hspace{\fill}同\hspace{\fill}指\hspace{\fill}導}} & %
\textbf{\fontsize{18pt}{0pt}\selectfont ：}
\makebox[4em][s]{\textbf{\fontsize{18pt}{0pt}\selectfont \CoAdvisortwname}} \\[8mm]
\else
\vspace{8mm}
\fi
\end{tabular}
...
\vspace{7.4mm}
\bfseries\fontsize{18pt}{0pt} \textsc{ \dateROC }
\end{center}
